...
namespace Warsztat.Controllers
{
    public class PartsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_part,PartName,Netto,Brutto,Quantity")] Parts parts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_part,PartName,Netto,Brutto,Quantity")] Parts parts)
        {
            if (ModelState.IsValid)
            {
